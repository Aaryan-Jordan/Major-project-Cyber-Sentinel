      ...
      <div className="relative min-h-screen w-full overflow-hidden bg-background">
        ...
        <section className="relative z-10 flex min-h-screen flex-col items-center justify-center px-4 text-center">
          <div className="max-w-3xl space-y-6">
            <h1 className="text-4xl font-bold leading-tight text-primary sm:text-5xl md:text-6xl">Cyber Sentinel</h1>
            ...
            <div className="mt-8 rounded-lg border border-border/50 bg-card/50 p-6 backdrop-blur-sm">
              <h3 className="mb-4 text-xl font-semibold text-primary">Project Team</h3>
